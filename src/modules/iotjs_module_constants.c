...
#define INTERNAL_IPC_HEADER_LENGTH_SIZE 4
#define INTERNAL_IPC_HEADER_TYPE_SIZE 1
#define INTERNAL_IPC_HEADER_RESERVED_SIZE 3
#define INTERNAL_IPC_HEADER_SIZE \
  INTERNAL_IPC_HEADER_LENGTH_SIZE + \
...
jerry_value_t InitConstants() {
  ...
  SET_CONSTANT(constants, INTERNAL_IPC_HEADER_LENGTH_SIZE);
  SET_CONSTANT(constants, INTERNAL_IPC_HEADER_TYPE_SIZE);
  SET_CONSTANT(constants, INTERNAL_IPC_HEADER_RESERVED_SIZE);
