...
/**
 * The Uint16Array.prototype object's 'slice' routine
 *
 * See also:
 ...
 */
static ecma_value_t
ecma_builtin_uint16array_prototype_object_slice (ecma_value_t this_arg, /**< 'this' argument */
                                                 ...
                                                 ecma_value_t arg2) /**< end */
{
  ...
  return ret_value;
} /* ecma_builtin_uint16array_prototype_object_slice */
