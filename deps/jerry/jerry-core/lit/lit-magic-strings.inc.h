...
LIT_MAGIC_STRING_DEF (LIT_MAGIC_STRING_PROPERTY, "property")
#if !defined (CONFIG_DISABLE_DATE_BUILTIN)
...
LIT_MAGIC_STRING_DEF (LIT_MAGIC_STRING_ARROW_FUNCTION, "<arrow function>")
#endif
...
LIT_MAGIC_STRING_DEF (LIT_MAGIC_STRING_EXTERNAL_FUNCTION, "<external function>")
#endif
...
#if defined (JERRY_HEAP_PROFILER)
LIT_MAGIC_STRING_DEF (LIT_MAGIC_STRING_LEX_ENV, "<lexical environment>")
#endif
...
LIT_MAGIC_STRING_FIRST_STRING_WITH_SIZE (15, LIT_MAGIC_STRING_ARROW_FUNCTION)
#else
LIT_MAGIC_STRING_FIRST_STRING_WITH_SIZE (15, LIT_MAGIC_STRING_DEFINE_PROPERTIES_UL)
#endif
#if !defined (CONFIG_DISABLE_ES2015_ARROW_FUNCTION) && defined (JERRY_HEAP_PROFILER)
LIT_MAGIC_STRING_FIRST_STRING_WITH_SIZE (16, LIT_MAGIC_STRING_ARROW_FUNCTION)
#else
...
#if defined (JERRY_HEAP_PROFILER)
LIT_MAGIC_STRING_FIRST_STRING_WITH_SIZE (19, LIT_MAGIC_STRING_EXTERNAL_FUNCTION)
#else
...
#if defined (JERRY_HEAP_PROFILER)
LIT_MAGIC_STRING_FIRST_STRING_WITH_SIZE (21, LIT_MAGIC_STRING_LEX_ENV)
#else
