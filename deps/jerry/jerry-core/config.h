...
#ifdef MULTIPLY_HEAP_MAX_LIMIT_VALUE
    #define CONFIG_MEM_HEAP_MAX_LIMIT (8192 * MULTIPLY_HEAP_MAX_LIMIT_VALUE)
    #define CONFIG_MEM_HEAP_DESIRED_LIMIT (JERRY_MIN (CONFIG_MEM_HEAP_AREA_SIZE / (32 * MULTIPLY_HEAP_MAX_LIMIT_VALUE), CONFIG_MEM_HEAP_MAX_LIMIT))
#endif
